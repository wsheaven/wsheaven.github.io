...
const url = 'https://api.openweathermap.org/data/2.5/weather?id=5607916&exclude=daily,minutely&units=imperial&appid=0e5b05eb0ed41a7bdddd22f966ff4fd2'
...
const requestURL = 'https://api.openweathermap.org/data/2.5/forecast?id=5607916&exclude=daily,minutely&units=imperial&appid=0e5b05eb0ed41a7bdddd22f966ff4fd2';
var boxclass = 0
...
const townstuff = 'https://byui-cit230.github.io/weather/data/towndata.json';
...
fetch(townstuff)
  ...
  .then(function (jsonObject) {
    ...
    p1.textContent = jsonObject["towns"][0].events[0]
    card.appendChild(p1);

    let p2 = document.createElement('p');
    p2.textContent = jsonObject["towns"][0].events[1]
    card.appendChild(p2);

    let p3 = document.createElement('p');
    p3.textContent = jsonObject["towns"][0].events[2]
    card.appendChild(p3);
